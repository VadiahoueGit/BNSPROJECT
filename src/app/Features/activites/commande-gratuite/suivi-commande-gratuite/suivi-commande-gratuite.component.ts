...
@Component({
  selector: 'app-suivi-commande-gratuite',
  templateUrl: './suivi-commande-gratuite.component.html',
  styleUrls: ['./suivi-commande-gratuite.component.scss']
})
export class SuiviCommandeGratuiteComponent {
