...
@Component({
  selector: 'app-vente-global',
  templateUrl: './vente-global.component.html',
  styleUrls: ['./vente-global.component.scss']
})
export class VenteGlobalComponent {
 @ViewChild('dt2') dt2!: Table;
  ...
  GetListVenteGlobal(page:number) {
    let data = {
      paginate: false,
      page:page,
      limit: 8,
    ...
    this._spinner.show();
    this._activiteService.GetVenteGlobalList(data).then((res: any) => {
