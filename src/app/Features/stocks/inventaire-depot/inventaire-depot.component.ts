...
@Component({
  selector: 'app-inventaire-depot',
  templateUrl: './inventaire-depot.component.html',
  styleUrls: ['./inventaire-depot.component.scss']
})
export class InventaireDepotComponent {
