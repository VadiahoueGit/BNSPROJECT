...
export class InventaireStoksComponent {
  ...
  onSubmit(): void {
    ...
    if (this.InventaireForm.valid) {
      // const formValues = this.InventaireForm.value; 
      this._spinner.show();
      const formValues = {
        ...this.InventaireForm.value,
        categorieId: +this.InventaireForm.value.categorieId,
        groupeId: +this.InventaireForm.value.groupeId,
        plastiquenuId: +this.InventaireForm.value.plastiquenuId,
        bouteillevideId: +this.InventaireForm.value.bouteillevideId,
        liquideId: +this.InventaireForm.value.liquideId,
      };
